...
echo   - POST /api/v1/days/calculate
echo   - POST /api/v1/convert
echo   - POST /api/v1/temperature/stats
...
echo    curl -X POST http://localhost:%PORT%/api/v1/days/calculate ^
echo      -H "Content-Type: application/json" ^
echo      -d "{\"startDate\":\"2024-01-01\",\"endDate\":\"2024-12-31\"}"
echo.
echo 2. Convert number to words:
echo    curl -X POST http://localhost:%PORT%/api/v1/convert ^
echo      -H "Content-Type: application/json" ^
echo      -d "{\"number\":36.40}"
echo.
echo 3. Get temperature stats:
echo    curl -X POST http://localhost:%PORT%/api/v1/temperature/stats ^
echo      -H "Content-Type: application/json" ^
echo      -d "{\"startDate\":\"2025-01-01\",\"endDate\":\"2025-01-07\"}"
echo.
echo =====================================
